...
/**
 * The {@code CloudProcessor} implements all specific functionality to calculate a cloud probability.
 */
...
public class CloudOperator extends Operator {
    ...
    static Path getAuxdataInstallationPath() {
        return ModuleActivator.AUXDATA_DIR.resolve("cloud");
    }
