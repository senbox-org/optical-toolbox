...
class CloudPN extends ProcessingNode {
    ...
    public CloudPN(Path auxdataDir) {
    ...
    public void setUp(final Map config) throws IOException {
        ...
        final Path propertiesFile = auxdataDir.resolve((String) config.get(CONFIG_FILE_NAME));
        final InputStream propertiesStream = Files.newInputStream(propertiesFile);
        Properties properties = new Properties();
        properties.load(propertiesStream);

        landAlgo = new CloudAlgorithm(auxdataDir, properties.getProperty("land"));
        oceanAlgo = new CloudAlgorithm(auxdataDir, properties.getProperty("ocean"));
        ...
        centralWavelengthProvider.readAuxData(auxdataDir);
