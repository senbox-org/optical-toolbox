...
public class EqualizationLUTTest {
    ...
    private void compare(double[] expected, double[] actualCoefficients) {
        assertEquals(expected[0], actualCoefficients[0], 1.0e-6);
        assertEquals(expected[1], actualCoefficients[1], 1.0e-6);
        assertEquals(expected[2], actualCoefficients[2], 1.0e-6);
    }
