...
@OperatorMetadata(
        ...
        description = "MCARI/OSAVI Ratio",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class McariosaviOp extends BaseIndexOp {
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        ...
        try {
            ...
            Tile mcariosaviFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));

            float mcariosaviValue;
