...
@OperatorMetadata(
        ...
        description = "Simple Ratio (705 and 750 nm)",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Sr705Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "sr705";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Sr705", rectangle.height);
        try {
            ...
            Tile sr705 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile sr705Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    sr705Value = re2/re1;
                    sr705.setSample(x, y, computeFlag(x, y, sr705Value, sr705Flags));
                }
