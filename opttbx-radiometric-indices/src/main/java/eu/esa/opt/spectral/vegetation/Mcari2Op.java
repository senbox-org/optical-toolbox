...
@OperatorMetadata(
        ...
        description = "Modified Chlorophyll Absorption in Reflectance Index 2",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Mcari2Op extends BaseIndexOp {
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        ...
        try {
            ...
            Tile mcari2Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
