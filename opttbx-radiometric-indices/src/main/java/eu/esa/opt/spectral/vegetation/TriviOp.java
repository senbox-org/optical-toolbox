...
public class TriviOp extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "trivi";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Trivi", rectangle.height);
        try {
            ...
            Tile trivi = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile triviFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    triviValue = 0.5f*(120*(n-g)-200*(r-g));
                    trivi.setSample(x, y, computeFlag(x, y, triviValue, triviFlags));
                }
