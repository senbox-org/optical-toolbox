...
@OperatorMetadata(
        ...
        description = "Disease-Water Stress Index 4",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Dswi4Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "dswi4";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Dswi4", rectangle.height);
        try {
            ...
            Tile dswi4 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile dswi4Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    dswi4Value = g/r;
                    dswi4.setSample(x, y, computeFlag(x, y, dswi4Value, dswi4Flags));
                }
