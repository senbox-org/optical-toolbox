...
@OperatorMetadata(
        ...
        description = "Modified Normalized Difference (705, 750 and 445 nm)",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Mmnd705Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "mmnd705";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Mmnd705", rectangle.height);
        try {
            ...
            Tile mmnd705 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile mmnd705Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    mmnd705Value = (re2-re1)/(re2+re1-a);
                    mmnd705.setSample(x, y, computeFlag(x, y, mmnd705Value, mmnd705Flags));
                }
