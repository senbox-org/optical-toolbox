...
public class NirvOp extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "nirv";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Nirv", rectangle.height);
        try {
            ...
            Tile nirv = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile nirvFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    nirvValue = ((n-r)/(n+r))*n;
                    nirv.setSample(x, y, computeFlag(x, y, nirvValue, nirvFlags));
                }
