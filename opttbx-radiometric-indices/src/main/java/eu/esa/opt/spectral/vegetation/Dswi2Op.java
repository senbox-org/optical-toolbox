...
@OperatorMetadata(
        ...
        description = "Disease-Water Stress Index 2",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Dswi2Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "dswi2";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Dswi2", rectangle.height);
        try {
            ...
            Tile dswi2 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile dswi2Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    dswi2Value = s1/g;
                    dswi2.setSample(x, y, computeFlag(x, y, dswi2Value, dswi2Flags));
                }
