...
@OperatorMetadata(
        ...
        description = "Soil-Adjusted Vegetation Index 2",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Savi2Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "savi2";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Savi2", rectangle.height);
        try {
            ...
            Tile savi2 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile savi2Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    savi2Value = n/(r+(slb/sla));
                    savi2.setSample(x, y, computeFlag(x, y, savi2Value, savi2Flags));
                }
