...
public class VariOp extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "vari";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Vari", rectangle.height);
        try {
            ...
            Tile vari = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile variFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    variValue = (g-r)/(g+r-b);
                    vari.setSample(x, y, computeFlag(x, y, variValue, variFlags));
                }
