...
@OperatorMetadata(
        ...
        description = "Vegetation Index (700 nm)",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Vi700Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "vi700";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Vi700", rectangle.height);
        try {
            ...
            Tile vi700 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile vi700Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    vi700Value = (re1-r)/(re1+r);
                    vi700.setSample(x, y, computeFlag(x, y, vi700Value, vi700Flags));
                }
