...
@OperatorMetadata(
        ...
        description = "Optimized Chlorophyll Vegetation Index",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class OcviOp extends BaseIndexOp {
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Ocvi", rectangle.height);
        try {
            ...
            Tile ocvi = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile ocviFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
