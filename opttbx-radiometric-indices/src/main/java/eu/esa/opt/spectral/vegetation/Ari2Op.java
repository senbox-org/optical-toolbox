...
public class Ari2Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "ari2";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Ari2", rectangle.height);
        try {
            ...
            Tile ari2 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile ari2Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    ari2Value = n*((1.0f/g)-(1.0f/re1));
                    ari2.setSample(x, y, computeFlag(x, y, ari2Value, ari2Flags));
                }
