...
@OperatorMetadata(
        ...
        description = "Red Edge Normalized Difference Vegetation Index",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class RendviOp extends BaseIndexOp {
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        ...
        try {
            ...
            Tile rendviFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
