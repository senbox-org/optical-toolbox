...
public class SrOp extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "sr";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Sr", rectangle.height);
        try {
            ...
            Tile sr = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile srFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    srValue = n/r;
                    sr.setSample(x, y, computeFlag(x, y, srValue, srFlags));
                }
