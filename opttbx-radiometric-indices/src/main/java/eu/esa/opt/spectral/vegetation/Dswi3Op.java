...
@OperatorMetadata(
        ...
        description = "Disease-Water Stress Index 3",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Dswi3Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "dswi3";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Dswi3", rectangle.height);
        try {
            ...
            Tile dswi3 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile dswi3Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    dswi3Value = s1/r;
                    dswi3.setSample(x, y, computeFlag(x, y, dswi3Value, dswi3Flags));
                }
