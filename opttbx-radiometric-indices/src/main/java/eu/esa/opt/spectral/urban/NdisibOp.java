...
@OperatorMetadata(
        ...
        description = "Normalized Difference Impervious Surface Index Blue",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class NdisibOp extends BaseIndexOp {
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        ...
        try {
            ...
            Tile ndisibFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
