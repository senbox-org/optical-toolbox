...
@OperatorMetadata(
        ...
        description = "Disease-Water Stress Index 1",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Dswi1Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "dswi1";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Dswi1", rectangle.height);
        try {
            ...
            Tile dswi1 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile dswi1Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    dswi1Value = n/s1;
                    dswi1.setSample(x, y, computeFlag(x, y, dswi1Value, dswi1Flags));
                }
