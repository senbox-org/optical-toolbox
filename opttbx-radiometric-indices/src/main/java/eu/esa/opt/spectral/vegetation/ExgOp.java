...
public class ExgOp extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "exg";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Exg", rectangle.height);
        try {
            ...
            Tile exg = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile exgFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    exgValue = 2*g-r-b;
                    exg.setSample(x, y, computeFlag(x, y, exgValue, exgFlags));
                }
