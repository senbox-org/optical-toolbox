...
@OperatorMetadata(
        ...
        description = "Modified Triangular Vegetation Index 1",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Mtvi1Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "mtvi1";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Mtvi1", rectangle.height);
        try {
            ...
            Tile mtvi1 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile mtvi1Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    mtvi1Value = 1.2f*(1.2f*(n-g)-2.5f*(r-g));
                    mtvi1.setSample(x, y, computeFlag(x, y, mtvi1Value, mtvi1Flags));
                }
