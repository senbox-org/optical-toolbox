...
@OperatorMetadata(
        ...
        description = "Simple Ratio (800 and 550 nm)",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Sr2Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "sr2";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Sr2", rectangle.height);
        try {
            ...
            Tile sr2 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile sr2Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    sr2Value = n/g;
                    sr2.setSample(x, y, computeFlag(x, y, sr2Value, sr2Flags));
                }
