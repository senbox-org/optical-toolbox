...
@OperatorMetadata(
        ...
        description = "Modified Chlorophyll Absorption in Reflectance Index (705 and 750 nm)",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Mcari705Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "mcari705";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Mcari705", rectangle.height);
        try {
            ...
            Tile mcari705 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile mcari705Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    mcari705Value = ((re2-re1)-0.2f*(re2-g))*(re2/re1);
                    mcari705.setSample(x, y, computeFlag(x, y, mcari705Value, mcari705Flags));
                }
