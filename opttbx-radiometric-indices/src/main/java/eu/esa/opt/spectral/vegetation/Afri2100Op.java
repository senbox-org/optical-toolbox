...
@OperatorMetadata(
        ...
        description = "Aerosol Free Vegetation Index (2100 nm)",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Afri2100Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "afri2100";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Afri2100", rectangle.height);
        try {
            ...
            Tile afri2100 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile afri2100Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    afri2100Value = (n-0.5f*s2)/(n+0.5f*s2);
                    afri2100.setSample(x, y, computeFlag(x, y, afri2100Value, afri2100Flags));
                }
