...
@OperatorMetadata(
        ...
        description = "NIR-SWIR-Temperature Version 1",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Nstv1Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "nstv1";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Nstv1", rectangle.height);
        try {
            ...
            Tile nstv1 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile nstv1Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    nstv1Value = ((n-s2)/(n+s2))*t;
                    nstv1.setSample(x, y, computeFlag(x, y, nstv1Value, nstv1Flags));
                }
