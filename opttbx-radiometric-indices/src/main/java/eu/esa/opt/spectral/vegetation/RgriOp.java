...
public class RgriOp extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "rgri";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Rgri", rectangle.height);
        try {
            ...
            Tile rgri = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile rgriFlags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    rgriValue = r/g;
                    rgri.setSample(x, y, computeFlag(x, y, rgriValue, rgriFlags));
                }
