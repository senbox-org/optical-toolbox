...
@OperatorMetadata(
        ...
        description = "Normalized Difference (705 and 750 nm)",
        authors = "Adrian Draghici",
        copyright = "Copyright (C) 2025 by CS Group ROMANIA")
public class Nd705Op extends BaseIndexOp {

    // constants
    public static final String BAND_NAME = "nd705";
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle rectangle, ProgressMonitor pm) throws OperatorException {
        pm.beginTask("Computing Nd705", rectangle.height);
        try {
            ...
            Tile nd705 = targetTiles.get(getBandWithSuffix(targetProduct, "_" + BAND_NAME));
            Tile nd705Flags = targetTiles.get(targetProduct.getBand(FLAGS_BAND_NAME));
            ...
            for (int y = rectangle.y; y < rectangle.y + rectangle.height; y++) {
                for (int x = rectangle.x; x < rectangle.x + rectangle.width; x++) {
                    ...
                    nd705Value = (re2-re1)/(re2+re1);
                    nd705.setSample(x, y, computeFlag(x, y, nd705Value, nd705Flags));
                }
