...
import eu.esa.opt.meris.radiometry.MerisRadiometryCorrectionOp;
...
@ActionID(category = "Processing", id = "eu.esa.opt.meris.radiometry.ui.MerisRadiometryCorrectionAction" )
