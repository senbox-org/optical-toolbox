...
import static eu.esa.opt.fu.Instrument.Constants.CZCS_BAND_NAME_PATTERN;
import static eu.esa.opt.fu.Instrument.Constants.CZCS_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.CZCS_VALID_EXPRESSIONS;
import static eu.esa.opt.fu.Instrument.Constants.CZCS_WAVELENGTHS;
import static eu.esa.opt.fu.Instrument.Constants.CZCS_XFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.CZCS_YFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.CZCS_ZFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MERIS_BAND_NAME_PATTERN;
import static eu.esa.opt.fu.Instrument.Constants.MERIS_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MERIS_VALID_EXPRESSIONS;
import static eu.esa.opt.fu.Instrument.Constants.MERIS_WAVELENGTHS;
import static eu.esa.opt.fu.Instrument.Constants.MERIS_XFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MERIS_YFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MERIS_ZFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS500_BAND_NAME_PATTERN;
import static eu.esa.opt.fu.Instrument.Constants.MODIS500_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS500_VALID_EXPRESSIONS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS500_WAVELENGTHS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS500_XFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS500_YFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS500_ZFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS_BAND_NAME_PATTERN;
import static eu.esa.opt.fu.Instrument.Constants.MODIS_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS_VALID_EXPRESSIONS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS_WAVELENGTHS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS_XFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS_YFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MODIS_ZFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MSI_BAND_NAME_PATTERN;
import static eu.esa.opt.fu.Instrument.Constants.MSI_VALID_EXPRESSIONS;
import static eu.esa.opt.fu.Instrument.Constants.MSI_WAVELENGTHS;
import static eu.esa.opt.fu.Instrument.Constants.MSI_XFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MSI_YFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.MSI_ZFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.OLCI_BAND_NAME_PATTERN;
import static eu.esa.opt.fu.Instrument.Constants.OLCI_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.OLCI_VALID_EXPRESSIONS;
import static eu.esa.opt.fu.Instrument.Constants.OLCI_WAVELENGTHS;
import static eu.esa.opt.fu.Instrument.Constants.OLCI_XFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.OLCI_YFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.OLCI_ZFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.S2A_MSI_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.S2B_MSI_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.SEAWIFS_BAND_NAME_PATTERN;
import static eu.esa.opt.fu.Instrument.Constants.SEAWIFS_POLYFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.SEAWIFS_VALID_EXPRESSIONS;
import static eu.esa.opt.fu.Instrument.Constants.SEAWIFS_WAVELENGTHS;
import static eu.esa.opt.fu.Instrument.Constants.SEAWIFS_XFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.SEAWIFS_YFACTORS;
import static eu.esa.opt.fu.Instrument.Constants.SEAWIFS_ZFACTORS;
...
//                    // also see eu.esa.opt.dataio.landsat.geotiff.Landsat8Metadata#getSunAngleCorrectionFactor
