...
class Sentinel3RgbProfiles {
    ...
    static void registerRGBProfiles() {
        ...
        manager.addProfile(createSynAodProfile());
        manager.addProfile(createSynVegProfile());
    }

    static RGBImageProfile createSynAodProfile() {
        return new RGBImageProfile("SYN AOD SLSTR/OLCI- False colour",
                new String[]{
    ...
    static RGBImageProfile createSynVegProfile() {
        return new RGBImageProfile("SYN VG1/V10/VGP SLSTR/OLCI - False colour",
                new String[]{
                        "B3",
                        "B2",
                        "B0"
