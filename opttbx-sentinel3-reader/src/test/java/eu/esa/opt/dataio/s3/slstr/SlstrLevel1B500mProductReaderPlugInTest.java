...
public class SlstrLevel1B500mProductReaderPlugInTest {
    ...
    public void testGetDecodeQualification() {
        ...
        DecodeQualification decodeQualification = plugIn.getDecodeQualification("S3A_SL_1_RBT____20130707T153752_20130707T154252_20150217T183530_0299_158_182______SVL_O_NR_001.SEN3" + sep + "xfdumanifest.xml");
        assertEquals(DecodeQualification.SUITABLE, decodeQualification);

        decodeQualification = plugIn.getDecodeQualification("S3A_SL_1_RBT____20130707T153752_20130707T154252_20150217T183530_0299_158_182______SVL_O_NR_001.SEN3" + sep + "L1c_Manifest.xml");
        assertEquals(DecodeQualification.SUITABLE, decodeQualification);

        decodeQualification = plugIn.getDecodeQualification("S3A_SL_1_RBT____20130707T153752_20130707T154252_20150217T183530_0299_158_182______SVL_O_NR_001.SEN3.zip");
        assertEquals(DecodeQualification.SUITABLE, decodeQualification);

        // the ones's we dont't support
        decodeQualification = plugIn.getDecodeQualification("S3A_SL_1_RBT____20180809T035343_20180809T035643_20180810T124116_0179_034_218_2520_MAR_O_NT_002.SEN3" + sep + "manifest.safe");
        assertEquals(DecodeQualification.UNABLE, decodeQualification);

        decodeQualification = plugIn.getDecodeQualification("S5P_NRTI_L2__SO2____20240219T082248_20240219T082748_32914_03_020601_20240219T090920.nc");
        assertEquals(DecodeQualification.UNABLE, decodeQualification);
    }
}
