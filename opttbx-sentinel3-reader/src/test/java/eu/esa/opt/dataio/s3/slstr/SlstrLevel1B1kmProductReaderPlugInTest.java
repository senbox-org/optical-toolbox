...
public class SlstrLevel1B1kmProductReaderPlugInTest {

    private SlstrLevel1B1kmProductReaderPlugIn plugIn;

    @Before
    public void setUp() {
        plugIn = new SlstrLevel1B1kmProductReaderPlugIn();
    }
    ...
    public void testGetProductFileFilter() {
        ...
        assertEquals("Sen3_SLSTRL1B_1km", productFileFilter.getFormatName());
        ...
        assertEquals("Sentinel-3 SLSTR L1B products in 1km resolution (*.xml,*.zip)", productFileFilter.getDescription());
    }
