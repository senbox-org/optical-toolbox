...
public class NN_YellowSubstanceTest {
    ...
    public void testNN_AtmCorrGetNumInputNode() throws Exception {
        ...
        int numInputNode = NN_YellowSubstance.compute(in, numNodesInput, out, numNodesOutput, width, mask, 0, a);
    ...
    public void testNN_AtmCorrGetNumOutputNode() throws Exception {
        int numNodesInput = 1;
        int numNodesOutput = -1;
        int numOutputNum = NN_YellowSubstance.compute(in, numNodesInput, out, numNodesOutput, width, mask, 0, a);
    ...
    public void testNN_AtmCorrCompute() throws Exception {
        ...
        float[][] exOutput = new float[][]{{-2.1057475f}};

        final int compute = NN_YellowSubstance.compute(input, 18, out, 1, width, mask, 0, a);
