package eu.esa.opt.fub.wew.util;
...
public class NN_TSMTest {
    ...
    public void testNN_AtmCorrGetNumInputNode() throws Exception {
        ...
        int numInputNode = NN_TSM.compute(in, numNodesInput, out, numNodesOutput, width, mask, 0, a);
    ...
    public void testNN_AtmCorrGetNumOutputNode() throws Exception {
        int numNodesInput = 1;
        int numNodesOutput = -1;
        int numOutputNum = NN_TSM.compute(in, numNodesInput, out, numNodesOutput, width, mask, 0, a);
    ...
    public void testNN_AtmCorrCheckOutputNode() throws Exception {
        ...
        int checkOutputNode = NN_TSM.compute(in, numNodesInput, out, numNodesOutput, width, mask, 0, a);
    ...
    public void testNN_AtmCorrCompute() throws Exception {
        ...
        float[][] exOutput = new float[][]{{-0.7276454f}};

        final int compute = NN_TSM.compute(input, 18, out, 1, width, mask, 0, a);
