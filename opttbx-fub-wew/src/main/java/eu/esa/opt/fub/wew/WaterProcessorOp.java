...
import eu.esa.opt.fub.wew.util.NN_AtmCorr;
import eu.esa.opt.fub.wew.util.NN_CHL;
import eu.esa.opt.fub.wew.util.NN_TSM;
import eu.esa.opt.fub.wew.util.NN_YellowSubstance;
import eu.esa.opt.fub.wew.util.WaterProcessorOzone;
...
public class WaterProcessorOp extends PixelOperator {
    ...
    protected void configureSourceSamples(SourceSampleConfigurer sampleConfigurer) throws OperatorException {
        ...
        sampleConfigurer.defineComputedSample(WaterProcessorOpConstant.SOURCE_SAMPLE_VALID_MASK, ProductData.TYPE_INT8, expression);
    }
