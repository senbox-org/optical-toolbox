...
import eu.esa.opt.dataio.avhrr.AvhrrFile;
import eu.esa.opt.dataio.avhrr.BandReader;
import eu.esa.opt.dataio.avhrr.calibration.IrRadianceCalibrator;
import eu.esa.opt.dataio.avhrr.calibration.IrTemperatureCalibrator;
import eu.esa.opt.dataio.avhrr.calibration.ReflectanceFactorCalibrator;
import eu.esa.opt.dataio.avhrr.calibration.VisibleRadianceCalibrator;
...
public class KlmAvhrrFile extends AvhrrFile implements AvhrrConstants {
    ...
    public KlmAvhrrFile(File file) {
        this.file = FileUtils.getCachedFile(file);
    }
