...
public class JaxaForestMapModelDescriptor extends AbstractLandCoverModelDescriptor {
    ...
    static {
        ...
        Path tilesFile = moduleBasePath.resolve("eu/esa/snap/landcover/auxdata/jaxa_tiles.txt");
        try {
    ...
    public JaxaForestMapModelDescriptor() {
        ...
        colourIndexFile = moduleBasePath.resolve("eu/esa/snap/landcover/auxdata/jaxaforestmap_index.col");
    }
