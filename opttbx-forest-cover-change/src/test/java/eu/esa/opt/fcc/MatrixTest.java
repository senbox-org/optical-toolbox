...
import eu.esa.opt.fcc.mahalanobis.MultiplyByConstantMatrix;
import eu.esa.opt.fcc.mahalanobis.MultiplyMatrix;
import eu.esa.opt.fcc.mahalanobis.StorageMatrix;
import eu.esa.opt.fcc.mahalanobis.SubMatrix;
import eu.esa.opt.fcc.mahalanobis.TransposeMatrix;
