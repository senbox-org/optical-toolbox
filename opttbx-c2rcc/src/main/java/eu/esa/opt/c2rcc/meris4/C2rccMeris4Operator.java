...
import eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.Result;
...
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.DEFAULT_MERIS_WAVELENGTH;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_ADET_AT_MAX;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_ADET_AT_MIN;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_AGELB_AT_MAX;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_AGELB_AT_MIN;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_APIG_AT_MAX;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_APIG_AT_MIN;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_BPART_AT_MAX;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_BPART_AT_MIN;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_BWIT_AT_MAX;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_BWIT_AT_MIN;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_CLOUD;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_IOP_OOR;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_KD489_AT_MAX;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_KD489_OOR;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_KDMIN_AT_MAX;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_KDMIN_OOR;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_RHOW_OOR;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_RHOW_OOS;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_RTOSA_OOR;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_RTOSA_OOS;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.FLAG_INDEX_VALID_PE;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.merband12_ix;
import static eu.esa.opt.c2rcc.meris4.C2rccMeris4Algorithm.merband15_ix;
...
public class C2rccMeris4Operator extends PixelOperator implements C2rccConfigurable {
    ...
    */
    ...
    protected void configureTargetProduct(ProductConfigurer productConfigurer) {
        ...
        Band conc_tsm = C2rccCommons.addVirtualBand(targetProduct, "conc_tsm", "iop_bpart * " + TSMfakBpart + " + iop_bwit * " + TSMfakBwit, "g m^-3", "Total suspended matter dry weight concentration");
        Band conc_chl = C2rccCommons.addVirtualBand(targetProduct, "conc_chl", "pow(iop_apig, " + CHLexp + ") * " + CHLfak, "mg m^-3", "Chlorophyll concentration");
        ...
        if (outputUncertainties) {
            ...
            Band unc_tsm = C2rccCommons.addVirtualBand(targetProduct, "unc_tsm", "unc_btot * " + TSMfakBpart, "g m^-3", "Uncertainty of total suspended matter (TSM) dry weight concentration");
            Band unc_chl = C2rccCommons.addVirtualBand(targetProduct, "unc_chl", "pow(unc_apig, " + CHLexp + ") * " + CHLfak, "mg m^-3", "Uncertainty of chlorophyll concentration");
