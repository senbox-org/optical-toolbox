package eu.esa.opt.c2rcc.modis;
...
import eu.esa.opt.c2rcc.util.TargetProductPreparer;
...
import static eu.esa.opt.c2rcc.modis.C2rccModisAlgorithm.*;
...
public class C2rccModisOperator extends PixelOperator implements C2rccConfigurable {
    ...
    */
    ...
    protected void configureTargetProduct(ProductConfigurer productConfigurer) {
        ...
        TargetProductPreparer.prepareTargetProduct(targetProduct, sourceProduct, SOURCE_RADIANCE_NAME_PREFIX, NN_INPUT_REFLEC_WAVELENGTHS,
        ...
        if (outputAngles) {
            for (String angleName : GEOMETRY_ANGLE_NAMES) {
                ...
                TargetProductPreparer.addBand(targetProduct, angleName, band.getUnit(), band.getDescription());
            }
        }
    }
