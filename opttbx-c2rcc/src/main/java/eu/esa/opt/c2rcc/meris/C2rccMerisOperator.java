...
import eu.esa.opt.c2rcc.util.SolarFluxLazyLookup;
...
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.DEFAULT_MERIS_WAVELENGTH;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.DEFAULT_SOLAR_FLUX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_ADET_AT_MAX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_ADET_AT_MIN;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_AGELB_AT_MAX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_AGELB_AT_MIN;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_APIG_AT_MAX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_APIG_AT_MIN;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_BPART_AT_MAX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_BPART_AT_MIN;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_BWIT_AT_MAX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_BWIT_AT_MIN;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_CLOUD;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_IOP_OOR;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_KD489_AT_MAX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_KD489_OOR;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_KDMIN_AT_MAX;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_KDMIN_OOR;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_RHOW_OOR;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_RHOW_OOS;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_RTOSA_OOR;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_RTOSA_OOS;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.FLAG_INDEX_VALID_PE;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_iop_rw;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_iop_unciop;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_iop_uncsumiop_unckd;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_rtosa_aann;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_rtosa_rpath;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_rtosa_rw;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_rtosa_trans;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_rw_iop;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_rw_kd;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.IDX_rw_rwnorm;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.merband12_ix;
import static eu.esa.opt.c2rcc.meris.C2rccMerisAlgorithm.merband15_ix;
