...
import static eu.esa.opt.c2rcc.util.ArrayMath.a_abs;
import static eu.esa.opt.c2rcc.util.ArrayMath.a_exp;
import static eu.esa.opt.c2rcc.util.ArrayMath.a_sumx;
