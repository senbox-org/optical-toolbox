...
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_iop_rw;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_iop_unciop;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_iop_uncsumiop_unckd;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_rtosa_aann;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_rtosa_rpath;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_rtosa_rw;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_rtosa_trans;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_rw_iop;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_rw_kd;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.IDX_rw_rwnorm;
