...
import static eu.esa.opt.c2rcc.C2rccCommons.ensureTimeInformation;
import static eu.esa.opt.c2rcc.C2rccCommons.fetchOzone;
import static eu.esa.opt.c2rcc.C2rccCommons.fetchSurfacePressure;
import static eu.esa.opt.c2rcc.C2rccCommons.getTimeCoding;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_ADET_AT_MAX;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_ADET_AT_MIN;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_AGELB_AT_MAX;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_AGELB_AT_MIN;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_APIG_AT_MAX;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_APIG_AT_MIN;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_BPART_AT_MAX;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_BPART_AT_MIN;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_BWIT_AT_MAX;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_BWIT_AT_MIN;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_CLOUD;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_IOP_OOR;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_KD489_AT_MAX;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_KD489_OOR;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_KDMIN_AT_MAX;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_KDMIN_OOR;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_RHOW_OOR;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_RHOW_OOS;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_RTOSA_OOR;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_RTOSA_OOS;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.FLAG_INDEX_VALID_PE;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.NN_SOURCE_BAND_REFL_NAMES;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.Result;
import static eu.esa.opt.c2rcc.msi.C2rccMsiAlgorithm.SOURCE_BAND_REFL_NAMES;
