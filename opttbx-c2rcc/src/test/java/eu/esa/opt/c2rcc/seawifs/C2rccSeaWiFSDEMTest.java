package eu.esa.opt.c2rcc.seawifs;
...
public class C2rccSeaWiFSDEMTest {

    final C2rccSeaWiFSOperator operator = initOperator();
    ...
    public void testfailedDemInitialisation() throws Exception {
        ...
        operator.setParameter("demName", C2rccSeaWiFSOperator.DEM_NAME_GETASSE30);
    ...
    public void testDEMCopernicus90() throws Exception {
        operator.setParameter("demName", C2rccSeaWiFSOperator.DEFAULT_DEM_NAME);
    ...
    public void testDEMCopernicus30() throws Exception {
        operator.setParameter("demName", C2rccSeaWiFSOperator.DEM_NAME_COPERNICUS30);
        operator.initialiseElevationModel();
    ...
    private C2rccSeaWiFSOperator initOperator() {
        return (C2rccSeaWiFSOperator) new C2rccSeaWiFSOperator.Spi().createOperator();
    }
