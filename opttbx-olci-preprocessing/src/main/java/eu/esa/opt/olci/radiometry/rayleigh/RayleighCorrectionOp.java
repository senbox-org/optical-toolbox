...
import eu.esa.opt.olci.radiometry.Sensor;
import eu.esa.opt.olci.radiometry.SensorConstants;
import eu.esa.opt.olci.radiometry.gasabsorption.GaseousAbsorptionAux;
...
public class RayleighCorrectionOp extends Operator {
    ...
    public void initialize() throws OperatorException {
        ...
        sensor = SmileCorrectionUtils.getSensorType(sourceProduct);
    ...
    public void computeTileStack(Map<Band, Tile> targetTiles, Rectangle targetRectangle, ProgressMonitor pm) throws OperatorException {
        ...
        entries.forEach(targetTileStream -> {
            ...
            final int sourceBandIndex = SmileCorrectionUtils.getSourceBandIndex(targetBandName);
    ...
    private double[] waterVaporCorrection709(double[] reflectances, Rectangle targetRectangle, Sensor sensor) {
        double[] bWVRefTile = SmileCorrectionUtils.getSampleDoubles(getSourceTile(sourceProduct.getBand(sensor.getUpperWvBandName()), targetRectangle));
        double[] bWVTile = SmileCorrectionUtils.getSampleDoubles(getSourceTile(sourceProduct.getBand(sensor.getLowerWvBandName()), targetRectangle));
    ...
    private RayleighAux createAuxiliary(Product sourceProduct, Sensor sensor, Rectangle rectangle) {
        ...
        if (sensor.equals(Sensor.MERIS)) {
            rayleighAux.setSunAzimuthAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_SAA_NAME), rectangle));
            rayleighAux.setSunZenithAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_SZA_NAME), rectangle));
            rayleighAux.setViewZenithAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_VZA_NAME), rectangle));
            rayleighAux.setViewAzimuthAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_VAA_NAME), rectangle));
            rayleighAux.setSeaLevels(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_SLP_NAME), rectangle));
            rayleighAux.setTotalOzones(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_OZONE_NAME), rectangle));
            rayleighAux.setLatitudes(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_LAT_NAME), rectangle));
            rayleighAux.setLongitude(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_LON_NAME), rectangle));
            rayleighAux.setAltitudes(getSourceTile(sourceProduct.getRasterDataNode(ALTITUDE_DEM), rectangle));
        } else if (sensor.equals(Sensor.MERIS_4TH)) {
            rayleighAux.setSunAzimuthAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_4TH_SAA_NAME), rectangle));
            rayleighAux.setSunZenithAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_4TH_SZA_NAME), rectangle));
            rayleighAux.setViewZenithAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_4TH_VZA_NAME), rectangle));
            rayleighAux.setViewAzimuthAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_4TH_VAA_NAME), rectangle));
            rayleighAux.setSeaLevels(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_4TH_SLP_NAME), rectangle));
            rayleighAux.setTotalOzones(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.MERIS_4TH_OZONE_NAME), rectangle));
            ...
            rayleighAux.setSunZenithAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.OLCI_SZA_NAME), rectangle));
            rayleighAux.setViewZenithAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.OLCI_VZA_NAME), rectangle));
            rayleighAux.setSunAzimuthAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.OLCI_SAA_NAME), rectangle));
            rayleighAux.setViewAzimuthAngles(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.OLCI_VAA_NAME), rectangle));
            rayleighAux.setSeaLevels(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.OLCI_SLP_NAME), rectangle));
            rayleighAux.setOlciTotalOzones(getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.OLCI_OZONE_NAME), rectangle));
            ...
            final Tile szaTile = getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.S2_MSI_SZA_NAME), rectangle);
            rayleighAux.setSunZenithAngles(szaTile);
            final Tile vzaTile = getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.S2_MSI_VZA_NAME), rectangle);
            rayleighAux.setViewZenithAngles(vzaTile);
            final Tile saaTile = getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.S2_MSI_SAA_NAME), rectangle);
            rayleighAux.setSunAzimuthAngles(saaTile);
            final Tile vaaTile = getSourceTile(sourceProduct.getRasterDataNode(SensorConstants.S2_MSI_VAA_NAME), rectangle);
