...
import eu.esa.opt.dataio.s2.S2Constant;
...
import eu.esa.opt.dataio.s2.tiles.TileIndexBandMatrixCell;
import eu.esa.opt.dataio.s2.tiles.TileIndexMultiLevelSource;
    ...
    private void addRasterMask(Product product, List<S2Metadata.Tile> tileList, MaskInfo148 maskInfo,
        ...
        if (spectralInfo == null) {
            ...
            for (int i = 0; i < subType.length; i++) {
                ...
                if (maskBandName.contains("detector_footprint")) {
                    quantificationValue = 1.0;
                }
