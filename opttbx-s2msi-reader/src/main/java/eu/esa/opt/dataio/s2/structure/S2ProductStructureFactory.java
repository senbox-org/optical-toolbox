...
package eu.esa.opt.dataio.s2.structure;
...
public class S2ProductStructureFactory {
    ...
    public static S2ProductStructure create(ProductType pt) throws Exception {
        if (pt == ProductType.S2TILE) {
            ...
            s2.addItem(new StructuralItem(false, StructuralItem.Type.FILE, true, "(S2A|S2B|S2C|S2_)_([A-Z|0-9]{4})_([A-Z|0-9|_]{4})([A-Z|0-9|_]{6})_([A-Z|0-9|_]+)(.[A-Z|a-z|0-9]{3})?"));
 ...
 S2ProductStructure s2 = new S2ProductStructure();
        ...
        if (pt == ProductType.S2L0PRODUCT) {
            ...
            s2.addItem(new StructuralItem(true, StructuralItem.Type.FILE, true, "(S2A|S2B|S2C|S2_)_([A-Z|0-9]{4})_([A-Z|0-9|_]{4})([A-Z|0-9|_]{6})_([A-Z|0-9|_]+)\\.(PNG|png)"));
