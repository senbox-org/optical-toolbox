...
package eu.esa.opt.dataio.s2.l2f;

import eu.esa.opt.dataio.VirtualDirEx;
import eu.esa.opt.dataio.s2.VirtualPath;
import eu.esa.opt.dataio.s2.l2hf.l2f.metadata.IL2fGranuleMetadata;
import eu.esa.opt.dataio.s2.l2hf.l2f.metadata.IL2fProductMetadata;
import eu.esa.opt.dataio.s2.l2hf.l2f.metadata.L2fMetadataFactory;
