...
package eu.esa.opt.olci.radiometry.smilecorr;

import com.bc.ceres.core.ProgressMonitor;
import eu.esa.opt.olci.radiometry.Sensor;
import eu.esa.opt.olci.radiometry.gasabsorption.GaseousAbsorptionAux;
import eu.esa.opt.olci.radiometry.rayleigh.RayleighAux;
import eu.esa.opt.olci.radiometry.rayleigh.RayleighCorrAlgorithm;
import eu.esa.opt.olci.radiometry.rayleigh.RayleighInput;
import eu.esa.opt.olci.radiometry.rayleigh.RayleighOutput;
...
public class SmileCorrectionOp extends Operator {
    ...
    public void initialize() throws OperatorException {
        sensor = SmileCorrectionUtils.getSensorType(getSourceProduct());
