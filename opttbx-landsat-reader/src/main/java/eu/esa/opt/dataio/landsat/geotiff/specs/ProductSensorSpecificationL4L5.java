...
/**
 * Landsat 4 & Landsat 5 product specification
...
public class ProductSensorSpecificationL4L5 extends ProductSensorSpecification {
    ...
    private static final Map<String, Float> wavelengths = Collections.unmodifiableMap(new HashMap<String, Float>() {{
        // see doc: https://d9-wret.s3.us-west-2.amazonaws.com/assets/palladium/production/s3fs-public/atoms/files/LSDS-1336_Landsat4-5-TM-C2-L2-DFCB-v4.pdf
        put("sr_b1", 485.0f);     // from doc: 450.0 - 520.0 nm  =  wl: 485.0  bw: 70.0
        put("sr_b2", 560.0f);     // from doc: 520.0 - 600.0 nm  =  wl: 560.0  bw: 80.0
        put("sr_b3", 660.0f);     // from doc: 630.0 - 690.0 nm  =  wl: 660.0  bw: 60.0
        put("sr_b4", 830.0f);     // from doc: 760.0 - 900.0 nm  =  wl: 830.0  bw: 140.0
        put("sr_b5", 1650.0f);    // from doc: 1550.0 - 1750.0 nm  =  wl: 1650.0  bw: 200.0
        put("st_b6", 11450.0f);    // from doc: 10400.0 - 12500.0 nm  =  wl: 11450.0  bw: 2100.0
        put("sr_b7", 2215.0f);  // from doc: 2080.0 - 2350.0 nm  =  wl: 2215.0  bw: 270.0
    }});

    private static final Map<String, Float> bandwidths = Collections.unmodifiableMap(new HashMap<String, Float>() {{
        // see doc: https://d9-wret.s3.us-west-2.amazonaws.com/assets/palladium/production/s3fs-public/atoms/files/LSDS-1336_Landsat4-5-TM-C2-L2-DFCB-v4.pdf
        put("sr_b1", 70.0f);     // from doc: 450.0 - 520.0 nm  =  wl: 485.0  bw: 70.0
        put("sr_b2", 80.0f);     // from doc: 520.0 - 600.0 nm  =  wl: 560.0  bw: 80.0
        put("sr_b3", 60.0f);     // from doc: 630.0 - 690.0 nm  =  wl: 660.0  bw: 60.0
        put("sr_b4", 140.0f);     // from doc: 760.0 - 900.0 nm  =  wl: 830.0  bw: 140.0
        put("sr_b5", 200.0f);    // from doc: 1550.0 - 1750.0 nm  =  wl: 1650.0  bw: 200.0
        put("st_b6", 2100.0f);    // from doc: 10400.0 - 12500.0 nm  =  wl: 11450.0  bw: 2100.0
        put("sr_b7", 270.0f);  // from doc: 2080.0 - 2350.0 nm  =  wl: 2215.0  bw: 270.0
    }});
	 ...
	 *
	 */
	ProductSensorSpecificationL4L5() {
		// Nothing to do
	}
