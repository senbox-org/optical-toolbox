package eu.esa.opt.meris.brr.operator;

import com.bc.ceres.core.ProgressMonitor;
import eu.esa.opt.meris.brr.dpm.AtmosphericCorrectionLand;
import eu.esa.opt.meris.brr.dpm.CloudClassification;
import eu.esa.opt.meris.brr.dpm.DpmPixel;
import eu.esa.opt.meris.brr.dpm.GaseousAbsorptionCorrection;
import eu.esa.opt.meris.brr.dpm.L1bDataExtraction;
import eu.esa.opt.meris.brr.dpm.PixelIdentification;
import eu.esa.opt.meris.brr.dpm.RayleighCorrection;
import eu.esa.opt.meris.l2auxdata.Constants;
