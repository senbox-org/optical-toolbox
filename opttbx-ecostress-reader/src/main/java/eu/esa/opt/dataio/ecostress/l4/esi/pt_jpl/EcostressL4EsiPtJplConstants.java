...
/**
 * Constants for ECOSTRESS L4 ESI PT JPL products
 *
 * @author adraghici
 */
class EcostressL4EsiPtJplConstants {
    ...
    static final String ECOSTRESS_L4_ESI_PT_JPL_PRODUCT_FILE_NAME_PATTERN = "ECOSTRESS_L4_ESI_PT-JPL_\\d{5}_\\d{3}_\\d{8}T\\d{6}_\\d{4}_\\d{2}.h5";
}
