...
/**
 * Constants for ECOSTRESS L4 WUE products
 *
 * @author adraghici
 */
class EcostressL4WueConstants {
    ...
    static final String ECOSTRESS_L4_WUE_PRODUCT_FILE_NAME_PATTERN = "ECOSTRESS_L4_WUE_\\d{5}_\\d{3}_\\d{8}T\\d{6}_\\d{4}_\\d{2}.h5";
}
