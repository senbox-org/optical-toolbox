...
/**
 * Reader for ECOSTRESS L2 Cloud products
 *
 * @author adraghici
 */
public class EcostressL2CloudProductReader extends EcostressAbstractProductReader {
     ...
     */
    protected EcostressL2CloudProductReader(ProductReaderPlugIn readerPlugIn) {
        super(readerPlugIn);
    }
    ...
    protected List<MetadataElement> getMetadataElementsList(EcostressFile ecostressFile) {
        return EcostressUtils.extractMetadataElements(ecostressFile, EcostressL2CloudConstants.ECOSTRESS_L2_CLOUD_PRODUCT_DATA_DEFINITIONS_GROUP_L2_CLOUD_METADATA);
    }
