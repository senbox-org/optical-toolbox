...
import eu.esa.opt.dataio.ceos.records.FilePointerRecord;
import eu.esa.opt.dataio.ceos.records.TextRecord;
import eu.esa.opt.dataio.ceos.records.VolumeDescriptorRecord;
