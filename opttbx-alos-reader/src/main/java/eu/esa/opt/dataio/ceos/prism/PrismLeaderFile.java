 ...
 */
package eu.esa.opt.dataio.ceos.prism;

import eu.esa.opt.dataio.ceos.records.Ancillary1Record;
import eu.esa.opt.dataio.ceos.records.Ancillary3Record;
import eu.esa.opt.dataio.ceos.CeosFileReader;
import eu.esa.opt.dataio.ceos.IllegalCeosFormatException;
import eu.esa.opt.dataio.ceos.prism.records.LeaderFileDescriptorRecord;
import eu.esa.opt.dataio.ceos.prism.records.PrismAncillary1Record;
import eu.esa.opt.dataio.ceos.prism.records.PrismAncillary2Record;
import eu.esa.opt.dataio.ceos.prism.records.SceneHeaderRecord;
